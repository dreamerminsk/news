...
function links(racer) {
  let links = `
    <a class="btn btn-outline-info btn-sm active" href="https://ru.wikipedia.org/wiki/${racer.wiki.ru}">
      <img width="16" height="16" src="https://ru.wikipedia.org/static/favicon/wikipedia.ico">
    </a>`;
  if (racer.champ) {
    links += `
    <a class="btn btn-outline-info btn-sm" href="https://www.championat.com/biathlon/_biathlonworldcup/tournament/${racer.champ.tournaments[0]}/players/${racer.champ.cc_id}/">
